...
public class PromptBuilder {
    ...
    public static String buildPrompt(String userInput, List<PlaceDTO> places) {
        ...
        sb.append("직접적으로 요청한 장소 유형이 후보 리스트에 없을 경우, 유사한 분위기나 목적에 맞는 장소를 대신 추천해도 됩니다.\n");
        sb.append("사용자의 표현이 구체적인 장소 유형을 포함하지만 후보 리스트에 없을 경우,\n");
        sb.append("문맥을 분석하여 감성, 목적, 분위기 등을 고려한 유사 장소를 추천해도 좋습니다.\n");
        sb.append("예: '조용한 카페' 요청 → '조용한 서점' 또는 '갤러리형 베이커리'\n");
        sb.append("단, 후보 리스트에 없는 장소를 새로 생성해서는 안 됩니다.\n\n");
